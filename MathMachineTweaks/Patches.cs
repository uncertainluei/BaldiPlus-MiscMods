...
// Patches SPECIFIC to 'Misc.MathMachines', or the Math Machine objects
namespace LuisRandomness.BBPMathMachineTweaks.Patches
{
    ...
    public class ChangeTotalTmpInit
    {
        ...
        static void Postfix(MathMachine __instance, TMP_Text ___totalTmp, int ___answeredProblems, int ___totalProblems)
        {
    ...
    {
        static void Prefix(MathMachine __instance, TMP_Text ___totalTmp, int ___answeredProblems, int ___totalProblems)
        {
